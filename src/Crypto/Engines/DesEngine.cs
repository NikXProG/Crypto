...
namespace Crypto.Engines
{
    public class DesEngine : IBlockCipher
    {
        ...
        public void Setup(bool encrypting, ICryptoParams cryptoParams)
        {
            ...
            _key = GenerationScheduleKey(encrypting, key.GetKey());
        }
        ...
        public int ProcessBlock(ReadOnlySpan<byte> input, Span<byte> output)
        {
            ...
            DesFunc(_key, ref hi32, ref lo32);
        ...
        private void DesFunc(int[] wKey, ref uint hi32, ref uint lo32)
        {
            uint left = hi32;
            uint right = lo32;
            uint work;
        ...
        protected static int[] GenerationScheduleKey(bool encrypting, byte[] key)
        {
