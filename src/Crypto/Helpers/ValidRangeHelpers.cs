...
{ 
    ...
    internal static class ValidRangeHelpers
    {
        
        internal static bool IsValidSize(this int size, ValidRangeSize legalSizes)
        {
        ...
        internal static bool IsValidSize(this int size, ValidRangeSize legalSizes, out bool validatedByZeroSkipSizeKeySizes)
        {
        ...
        internal static bool CheckValidSize(
            this int bitLength,
            ValidRangeSize[] legalSizes)
        {
            ValidRangeSize[] ranges = (ValidRangeSize[])legalSizes.Clone();
            if (ranges == null)
                return false;
