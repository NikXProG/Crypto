namespace Crypto.Domain.Enums
{
    ...
    {
        CBC = 1, // Sequential encryption. Error in ciphertext corrupts two blocks. (Requires blockPadding)
    
        PCBC = 2, // Error in ciphertext propagates to all following blocks, ensuring total corruption on tampering.
    
        CFB = 3, // Stream cipher mode. Self-recovering from sync errors. No blockPadding needed.
        ...
        CTR = 6, // PARALLEL. Efficient, no blockPadding. Critical: NEVER reuse counter value/key pair.
